...
import luck.materialdesign.tabsnavigator.fragments.ViewPagerAdapter;
...
public class MainActivity extends ActionBarActivity{
    ...
    CharSequence Titles[]={"CATEGORIES","HOME", "TOP BOOKS", "TOP AUTHORS"};
    int Numboftabs =4;
    ...
    private void init_slider() {
        ...
        tabs.setDistributeEvenly(true); // To make the Tabs Fixed set this true, This makes the fragments Space Evenly in Available width
