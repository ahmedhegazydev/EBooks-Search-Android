...
//            convertView.setId(Integer.parseInt(book.getIsbn()));
        } else {
        ...
        Picasso.with(getContext()).load(Uri.parse(book.getCoverUrl())).error(R.mipmap.ic_nocover).into(viewHolder.ivCover);
